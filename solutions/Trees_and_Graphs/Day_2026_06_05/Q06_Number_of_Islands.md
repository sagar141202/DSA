...
## Approach
The approach is to use Depth-First Search (DFS) to traverse the grid and count the number of islands. We start at each unvisited land cell and perform a DFS to mark all connected land cells as visited. The number of times we start a new DFS is equal to the number of islands.
...
- The number of times a new DFS is started is equal to the number of islands.