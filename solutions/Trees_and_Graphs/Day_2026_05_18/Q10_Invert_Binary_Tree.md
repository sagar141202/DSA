...
## Approach
To invert a binary tree, we can use a recursive approach by swapping the left and right child nodes of each internal node. We start with the root node and recursively invert the left and right subtrees.
