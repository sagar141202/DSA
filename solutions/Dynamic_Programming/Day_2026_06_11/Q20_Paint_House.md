...
## Approach
We can use dynamic programming to solve this problem by maintaining the minimum cost of painting the current house with each color. We will consider the minimum cost of painting the previous house with the other two colors.
...
- Maintain a 2D array `dp` to store the minimum cost of painting each house with each color.
