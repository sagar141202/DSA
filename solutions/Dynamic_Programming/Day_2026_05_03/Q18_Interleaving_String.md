...
- The `dp` array is used to store the results of subproblems to avoid redundant computation.
- The final result is stored in the last cell of the `dp` array.