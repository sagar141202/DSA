...
- Calculate the minimum cost to paint each house with each color based on the minimum cost to paint the previous house with a different color.
- Store the minimum cost to paint each house with each color in a 2D array for efficient lookup.