...
## Approach
Kadane's algorithm is used to solve this problem, which involves iterating over the array and at each step, deciding whether to continue the current subarray or start a new one. The algorithm keeps track of the maximum sum of subarray ending at each position.
