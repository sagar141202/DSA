...
- The key to the algorithm is to keep track of the maximum sum seen so far and to decide whether to continue the current subarray or start a new one at each step.