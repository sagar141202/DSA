...
## Approach
The algorithm uses a deque to keep track of the indices of the maximum elements in the current window. It iterates over the array, removing elements that are out of the current window and smaller than the current element. The maximum element in the current window is then added to the result.
...
- Remove elements that are out of the current window and smaller than the current element.
- The maximum element in the current window is the front element of the deque.