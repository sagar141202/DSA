...
## Approach
The Bellman-Ford algorithm works by iteratively relaxing all edges in the graph, starting from the source vertex. It uses a distance array to keep track of the shortest distance from the source vertex to all other vertices. The algorithm runs for V-1 iterations, where V is the number of vertices in the graph.
...
- The algorithm runs for V-1 iterations, where V is the number of vertices in the graph.
- The algorithm uses a distance array to keep track of the shortest distance from the source vertex to all other vertices.