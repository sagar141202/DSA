...
## Key Takeaways
- Sort the intervals by their end times to easily identify non-overlapping intervals.
- Iterate over the sorted intervals and select non-overlapping intervals greedily.
- The maximum number of non-overlapping intervals is the total number of intervals minus the count of overlapping intervals.