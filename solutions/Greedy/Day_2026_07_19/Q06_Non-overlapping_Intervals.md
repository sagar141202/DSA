...
public:
    int eraseOverlapIntervals(vector<vector<int>>& intervals) {
        ...
        // Iterate over the sorted intervals and select the non-overlapping ones
        ...
        // The maximum number of non-overlapping intervals is the total count of intervals minus the count of non-overlapping intervals
...
- The intervals are sorted based on their end times to ensure that the maximum number of non-overlapping intervals is achieved.
- The time complexity is O(n log n) due to the sorting operation, and the space complexity is O(n) for storing the intervals.